      ...
      <div class="form-section">
        ...
        <el-tabs v-model="activePhase" class="training-tabs">
          ...
          <el-tab-pane label="主体训练" name="main">
            <div class="phase-content">
              <div class="phase-header">
                <span class="phase-title">主体训练 (1-30个动作)</span>
          ...
          <el-tab-pane label="拉伸松解" name="stretch">
            <div class="phase-content">
              <div class="phase-header">
                <span class="phase-title">拉伸松解 (1-12个动作)</span>
      ...
      <div class="form-section">
        ...
        <el-form-item label="安全提醒" prop="safetyReminders">
          <el-input 
            ...
            type="textarea" 
            :rows="3"
            placeholder="请说明安全注意事项..."
            maxlength="500"
            show-word-limit
          />
        </el-form-item>

        <el-form-item label="效果预期" prop="expectedResults">
          <el-input 
            v-model="templateForm.expectedResults" 
            type="textarea" 
            :rows="3"
            placeholder="请说明使用此模板的预期效果..."
            maxlength="500"
            show-word-limit
          />
        </el-form-item>
...
const handleSubmit = async () => {
  try {
    ...
    if (response.ok) {
      ...
      ElMessage.error(errorData.message || '创建模板失败')
    }
